...
_CONFIGS = [
    ...
    TrainConfig(
        # Same 196-episode vision/joint fine-tune as above, but with a 30-frame
        # action chunk. At 15 Hz this covers exactly 2 seconds.
        name="pi05_droid_whiteboard_zed196_joint_position_finetune_h30",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=30,
    ...
    TrainConfig(
        # Same force-enabled 196-episode fine-tune as above, but with a 30-frame
        # action chunk. State layout remains joint/gripper/force padded to 32-D.
        name="pi05_droid_whiteboard_zed196_force_finetune_h30",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=30,
